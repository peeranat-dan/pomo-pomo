...
<template>
    <div class="bg-white rounded-xl shadow-sm w-full overflow-hidden container flow-root my-2 py-2 px-3" :class="isArchive ? '':'hover:shadow-md'">
        ...
        <div class="float-right flex space-x-2 text-center" v-if="!isArchive">
            ...
            <button :disabled="isDoingAction" type="button" class="text-white bg-red-pomo  focus:ring-2 focus:ring-red-200 transition ease-in-out duration-200 font-medium rounded-lg text-sm px-2 py-2 text-center inline-flex items-center" @click="btnFunction('delete')">
                ...
                <div v-else>
                    <svg class="inline w-4 h-4 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
